...
class Course:
    def __init__(self, center_x, center_y, outer_radius=300, inner_radius=125):
        ...
        self.bike2 = Bicycle(self, x=center_x + inner_radius + 10, y=center_y-100, color=GREEN, is_vector_cost=False, velocity_limit=18, opponent=self.bike1)  # Initialize bike
