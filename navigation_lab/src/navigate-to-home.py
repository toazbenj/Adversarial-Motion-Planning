...
class GoToPose():
    ...
    def goto(self, pos, quat):
        ...
        goal.target_pose.pose = Pose(Point(pos['x'], pos['y'], 0.01),
...
parser.add_argument("--r1", type=int, default=0.00, help="R1 quaternion")
parser.add_argument("--r2", type=int, default=0.00, help="R2 quaternion")
